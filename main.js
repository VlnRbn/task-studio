...
var map = {
	"./app-main/app-main.module": [
		"./src/app/app-main/app-main.module.ts",
		"app-main-app-main-module"
	]
};
...
/*!**********************************!*\
  !*** ./src/app/app.component.ts ***!
  \**********************************/
/*! exports provided: NotificationService, AppComponent */
...
var NotificationService = /** @class */ (function () {
    ...
    NotificationService.prototype.doSubsciption = function (subsciption) {
        return this.httpClient.post('users/notification/subscribe', subsciption);
    };
...
var AppComponent = /** @class */ (function () {
    function AppComponent(swPush, httpNotification) {
        this.swPush = swPush;
        this.httpNotification = httpNotification;
        this.title = 'frontend';
        this.VAPID = {
            "publicKey": "BJAB_Tbjg6Nh49mlZUg7gmab8bmGCNQN4fYRdML8Y8-zyFvKRzztg7v6Xh75S2qwTwkr1IuUGTxXcXYNZbEPzqQ",
            "privateKey": "AzF9o313ItuMQulasxqXMJTtOKAYVvgIMqRhZDLwlRY"
        };
    ...
    AppComponent.prototype.subscribeToNotifications = function () {
        ...
        this.swPush.requestSubscription({
            ...
            .then(function (sub) {
            _this.httpNotification.doSubsciption(sub)
                .subscribe(function (res) { console.log(sub); alert("subscribed"); });
        })
...
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
/* harmony import */ var _http_app_interceptor__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./http/app.interceptor */ "./src/app/http/app.interceptor.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
            ...
            providers: [
                {
                    ...
                    useClass: _http_app_interceptor__WEBPACK_IMPORTED_MODULE_3__["AppInterceptor"],
                    multi: true
                }
            ]
        })
...
/***/ "./src/app/http/app.interceptor.ts":
/*!*****************************************!*\
  !*** ./src/app/http/app.interceptor.ts ***!
  \*****************************************/
...
var AppInterceptor = /** @class */ (function () {
    ...
    AppInterceptor.prototype.intercept = function (req, next) {
        console.log('req', req);
        var localEndPoint = 'http://127.0.0.1:4600/api/';
        var prodEndPoint = 'http://192.168.50.28:4600/api/';
        req = req.clone({
            url: _environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].production ? prodEndPoint + req.url : localEndPoint + req.url
        });
...
module.exports = __webpack_require__(/*! /home/velen/Pace/task-studio/src/main.ts */"./src/main.ts");
